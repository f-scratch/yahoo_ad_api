...
require 'yahoo_ad_api/V201805/bid_landscape_service_registry'

module YahooAdApi; module V201805; module BidLandscapeService
  class BidLandscapeService < Shampoohat::SavonService
    def initialize(config, endpoint)
      namespace = 'http://ss.yahooapis.jp/V201805/BidLandscape'
      default_ns = 'ns1'
    ...
    def get_module()
      return YahooAdApi::V201805::BidLandscapeService
    end
  end
end; end; end
