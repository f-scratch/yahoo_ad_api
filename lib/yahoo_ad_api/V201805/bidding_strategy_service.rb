...
module YahooAdApi; module V201805; module BiddingStrategyService
  class BiddingStrategyService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V201805::BiddingStrategyService
    end
  end
end; end; end
