...
require 'yahoo_ad_api/V201805/campaign_shared_set_service_registry'
...
module YahooAdApi; module V201805; module CampaignSharedSetService
  class CampaignSharedSetService < Shampoohat::SavonService
    def initialize(config, endpoint)
      namespace = 'http://ss.yahooapis.jp/V201805/CampaignSharedSet'
      default_ns = 'ns1'
    ...
    def get_module()
      return YahooAdApi::V201805::CampaignSharedSetService
    end
  end
end; end; end
