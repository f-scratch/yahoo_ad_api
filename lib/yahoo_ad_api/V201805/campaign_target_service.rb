...
require 'yahoo_ad_api/V201805/campaign_target_service_registry'

module YahooAdApi; module V201805; module CampaignTargetService
  class CampaignTargetService < Shampoohat::SavonService
    def initialize(config, endpoint)
      namespace = 'http://ss.yahooapis.jp/V201805/CampaignTarget'
      default_ns = 'ns1'
    ...
    def get_module()
      return YahooAdApi::V201805::CampaignTargetService
    end
  end
end; end; end
