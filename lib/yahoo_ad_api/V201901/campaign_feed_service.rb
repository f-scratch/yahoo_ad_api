...
module YahooAdApi; module V201901; module CampaignFeedService
  class CampaignFeedService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V201901::CampaignFeedService
    end
  end
end; end; end
