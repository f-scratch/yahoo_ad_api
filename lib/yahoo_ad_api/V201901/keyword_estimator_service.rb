...
require 'yahoo_ad_api/V201901/keyword_estimator_service_registry'
...
module YahooAdApi; module V201901; module KeywordEstimatorService
  class KeywordEstimatorService < Shampoohat::SavonService
    def initialize(config, endpoint)
      namespace = 'http://ss.yahooapis.jp/V201901/KeywordEstimator'
      default_ns = 'ns1'
    ...
    def get_module()
      return YahooAdApi::V201901::KeywordEstimatorService
    end
  end
end; end; end
