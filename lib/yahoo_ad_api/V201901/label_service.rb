...
require 'yahoo_ad_api/V201901/label_service_registry'

module YahooAdApi; module V201901; module LabelService
  class LabelService < Shampoohat::SavonService
    def initialize(config, endpoint)
      namespace = 'http://ss.yahooapis.jp/V201901/Label'
      default_ns = 'ns1'
    ...
    def get_module()
      return YahooAdApi::V201901::LabelService
    end
  end
end; end; end
