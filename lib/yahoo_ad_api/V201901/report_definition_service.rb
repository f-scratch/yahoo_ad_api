...
require 'yahoo_ad_api/V201901/report_definition_service_registry'

module YahooAdApi; module V201901; module ReportDefinitionService
  class ReportDefinitionService < Shampoohat::SavonService
    def initialize(config, endpoint)
      namespace = 'http://ss.yahooapis.jp/V201901/ReportDefinition'
      default_ns = 'ns1'
    ...
    def get_module()
      return YahooAdApi::V201901::ReportDefinitionService
    end
  end
end; end; end
