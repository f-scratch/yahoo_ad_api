...
require 'yahoo_ad_api/V5_2/report_definition_service_registry'

module YahooAdApi; module V5_2; module ReportDefinitionService
  class ReportDefinitionService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V5_2::ReportDefinitionService
    end
  end
end; end; end
