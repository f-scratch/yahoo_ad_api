...
require 'yahoo_ad_api/V6_1/ad_group_criterion_service_registry'

module YahooAdApi; module V6_1; module AdGroupCriterionService
  class AdGroupCriterionService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_1::AdGroupCriterionService
    end
  end
end; end; end
