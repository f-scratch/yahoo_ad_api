...
require 'yahoo_ad_api/V6_1/ad_group_feed_service_registry'

module YahooAdApi; module V6_1; module AdGroupFeedService
  class AdGroupFeedService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_1::AdGroupFeedService
    end
  end
end; end; end
