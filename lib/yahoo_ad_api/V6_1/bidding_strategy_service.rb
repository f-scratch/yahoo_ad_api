...
require 'yahoo_ad_api/V6_1/bidding_strategy_service_registry'

module YahooAdApi; module V6_1; module BiddingStrategyService
  class BiddingStrategyService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_1::BiddingStrategyService
    end
  end
end; end; end
