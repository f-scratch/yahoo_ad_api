...
require 'yahoo_ad_api/V6_1/campaign_criterion_service_registry'

module YahooAdApi; module V6_1; module CampaignCriterionService
  class CampaignCriterionService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_1::CampaignCriterionService
    end
  end
end; end; end
