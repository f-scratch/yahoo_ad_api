...
require 'yahoo_ad_api/V6_1/campaign_target_service_registry'

module YahooAdApi; module V6_1; module CampaignTargetService
  class CampaignTargetService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_1::CampaignTargetService
    end
  end
end; end; end
