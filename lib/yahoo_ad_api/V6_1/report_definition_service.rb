...
require 'yahoo_ad_api/V6_1/report_definition_service_registry'

module YahooAdApi; module V6_1; module ReportDefinitionService
  class ReportDefinitionService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_1::ReportDefinitionService
    end
  end
end; end; end
