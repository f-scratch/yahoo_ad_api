...
require 'yahoo_ad_api/V6_2/campaign_target_service_registry'

module YahooAdApi; module V6_2; module CampaignTargetService
  class CampaignTargetService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_2::CampaignTargetService
    end
  end
end; end; end
