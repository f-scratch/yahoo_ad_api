...
require 'yahoo_ad_api/V6_2/report_definition_service_registry'

module YahooAdApi; module V6_2; module ReportDefinitionService
  class ReportDefinitionService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_2::ReportDefinitionService
    end
  end
end; end; end
