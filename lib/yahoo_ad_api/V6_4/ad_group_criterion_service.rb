...
require 'yahoo_ad_api/V6_4/ad_group_criterion_service_registry'

module YahooAdApi; module V6_4; module AdGroupCriterionService
  class AdGroupCriterionService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_4::AdGroupCriterionService
    end
  end
end; end; end
