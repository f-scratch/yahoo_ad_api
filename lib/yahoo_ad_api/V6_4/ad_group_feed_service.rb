...
require 'yahoo_ad_api/V6_4/ad_group_feed_service_registry'

module YahooAdApi; module V6_4; module AdGroupFeedService
  class AdGroupFeedService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_4::AdGroupFeedService
    end
  end
end; end; end
