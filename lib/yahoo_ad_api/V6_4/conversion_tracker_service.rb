...
require 'yahoo_ad_api/V6_4/conversion_tracker_service_registry'

module YahooAdApi; module V6_4; module ConversionTrackerService
  class ConversionTrackerService < Shampoohat::SavonService
    ...
    def get_module()
      return YahooAdApi::V6_4::ConversionTrackerService
    end
  end
end; end; end
